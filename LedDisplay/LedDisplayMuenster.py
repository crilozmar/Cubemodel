...
# Initialise logging
import logging
logger = logging.getLogger("icecube.LedDisplayMuenster")
...
try:
    ...
    i3_log_level = i3logging.LoggingBridge.global_logger.get_level_for_unit("LedDisplayMuenster")
...
try:
    ...
    class LedDisplayMuenster(PyArtist):
        numRequiredKeys = 2
        ...
        def __init__(self):
            ...
            self.addSetting(self._SETTING_PULSES_DURATION, ChoiceSetting(["Infinite","Standard finite","Bubbles-like finite"],0))
        ...
        def _handleOMKeyMapTimed(self, output, geometry, omkey_pulses_map):
            ...
            print "max charges 1 ", max_sum_charges
            max_sum_charges2 = 0.
            for led in charges:
                pulses = charges[led]
            ...
            print "max charges 2 ", max_sum_charges2        
                ...
                if duration:
                    ...
                    while tail < len(pulses):
                        ...
                        while pulses[head][0]+duration > t and head >= 0:
                            ...
                            head -= 1
                        brightness_value = (accumulated_charge/normalisation)**power
